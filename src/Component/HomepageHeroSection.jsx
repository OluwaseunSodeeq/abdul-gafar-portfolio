...
function HomepageHeroSection() {
  ...
  return (
    <div className=" relative mt-[96px] h-auto flex justify-center items-center flex-col  overflow-x-hidden  lg:mt-36 lg:pb-[60px] ">
      <motion.div
      ...
      <div className="bg-plain-white  w-full h-[65px] pb-3 pt-2   md:pt-1 absolute z-20  bottom-1  lg:bottom-[0px] text-center lg:pt-6  md:h-[85px] lg:h-[140px] border-none  ">
        <div className="">
          <TypeAnimation
            sequence={[
              "Abdul-Gafar Jimoh",
        ...
        <p className="font-normal text-sm md:text-lg lg:text-2xl leading-4 text-user-color text-center mt-3 md:mt-4">
      ...
      <div
        ...
        //  flex-col justify-center items-center h-auto absolute bottom-1 md:bottom-6 lg:bottom-[24px] z-10  "
        className="w-full flex
